...
df19<-read.csv("data/Chapter1DataSets/CH01PR19.txt", sep=" ", col.names=c("Y","X"))
df20<-read.csv("data/Chapter1DataSets/CH01PR20.txt", sep=" ", col.names=c("Y","X"))
df21<-read.csv("data/Chapter1DataSets/CH01PR21.txt", sep=" ", col.names=c("Y","X"))
df27<-read.csv("data/Chapter1DataSets/CH01PR27.txt", sep=" ", col.names=c("Y","X"))
```
# Chapter 1
