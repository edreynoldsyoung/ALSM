...
A *family confidence coefficent* is the probability, in advance of sampling, that the entire family of statemtns (e.g. $\beta_0 and \beta_1$) will be within a specified limit.
