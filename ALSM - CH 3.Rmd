...
Since $F^* =$ `r Fstar` and $F(1-\alpha; c-2; n-c) =$ `r F`, we can see that $F^* \leq F$ and we condlude $H_0$, that the function is linear. 
...
If these assumptions are not met, then a linear regression function may still fit the data, but the extimation of the regression parameters may not be accurate.
